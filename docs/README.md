...
This directory contains project-specific guidance for developers and coding
agents.

Authoritative behavior and scope are defined in `contract.md` at repository
root.

## Contents

- `developer/invariants.md` — mandatory implementation rules.
